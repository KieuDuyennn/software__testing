...
- Name: fr11_order_history\fr11.order-history.spec.ts >> FR-11 Order history view >> FR11-TC-18 [negative] a non-admin user must not be able to list every order in the system
- Location: automation\tests\fr11_order_history\fr11.order-history.spec.ts:320:5

# Error details

```
Error: FR11-TC-18 admin order list: http://localhost:3000/api/admin/orders answered 200, expected one of [401, 403]. Body: [{"id":26,"user_id":3,"total_amount":2000000,"status":"pending","shipping_address":"227 Nguyen Van Cu, Q5, TP.HCM","created_at":"2026-08-10 11:36:43","user_name":"FR11 Other User"},{"id":25,"user_id":2,"total_amount":1000000,"status":"pending","shipping_address":"227 Nguyen Van Cu, Q5, TP.HCM","crea
...
```
Error: FR11-TC-18: a non-admin account was served 26 orders belonging to other users

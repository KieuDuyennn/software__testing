...
- Name: fr11_order_history\fr11.order-history.spec.ts >> FR-11 Order history view >> FR11-TC-27 [negative] the cancel endpoint itself must refuse a shipping order
- Location: automation\tests\fr11_order_history\fr11.order-history.spec.ts:320:5

# Error details

```
Error: FR11-TC-27 cancel: http://localhost:3000/api/orders/2/cancel answered 200, expected one of [400]. Body: {"message":"Order canceled successfully"}
...
```
Error: FR11-TC-27: order #2 was cancelled despite the request being refused

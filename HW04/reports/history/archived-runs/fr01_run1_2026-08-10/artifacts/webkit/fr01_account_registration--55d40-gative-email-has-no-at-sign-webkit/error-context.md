...
- Name: fr01_account_registration\fr01.registration.spec.ts >> FR-01 Account registration >> FR01-TC-06 [negative] email has no at sign
...
```
Error: registration was refused, so userdomain.com must not be a usable account

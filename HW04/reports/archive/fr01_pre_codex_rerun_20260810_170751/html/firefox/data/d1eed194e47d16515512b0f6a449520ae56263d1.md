...
- Name: fr01_account_registration\fr01.registration.spec.ts >> FR-01 Account registration >> FR01-TC-07 [negative] email has no domain part
...
```
Error: registration was refused, so user@ must not be a usable account

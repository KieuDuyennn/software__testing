...
```
Error: FR11-TC-15 order detail: http://localhost:3000/api/orders/24 answered 200, expected one of [401, 403]. Body: {"id":24,"user_id":2,"total_amount":1000000,"status":"pending","shipping_address":"227 Nguyen Van Cu, Q5, TP.HCM","created_at":"2026-08-10 11:36:39"}

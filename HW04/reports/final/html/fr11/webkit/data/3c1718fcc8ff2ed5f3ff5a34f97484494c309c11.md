...
- Name: fr11_order_history\fr11.order-history.spec.ts >> FR-11 Order history view >> FR11-TC-31 [edge] a non-numeric order total must not render as NaN
- Location: automation\tests\fr11_order_history\fr11.order-history.spec.ts:320:5

# Error details

```
Error: FR11-TC-31: money cell renders "NaN ₫", which must not contain "NaN" - the seeded total was "abc"
        ...
        - table [ref=e31]:
          ...
          - rowgroup [ref=e39]:
            ...
            - row [ref=e47]:
              ...
              - cell "Đã giao" [ref=e51]
              - cell [ref=e52]
            - row [ref=e53]:
              - cell "#4" [ref=e54]
              - cell "8/10/2026" [ref=e55]
              - cell "1,000,000 ₫" [ref=e56]
              - cell "Đã hủy" [ref=e57]
              - cell [ref=e58]
            - row [ref=e59]:
              - cell "#2" [ref=e60]
            ...
            - row [ref=e65]:
              - cell "#1" [ref=e66]
              - cell "8/10/2026" [ref=e67]
              - cell "1,000,000 ₫" [ref=e68]
              - cell "Đã hủy" [ref=e69]
              - cell [ref=e70]
  - contentinfo [ref=e71]: © 2026 EShop SUT. Dành cho mục đích kiểm thử.
```

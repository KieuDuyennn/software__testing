...
- **Finding IDs are `D-0NN`, allocated when a finding is written, never in advance.** D-001…D-022
  ...
  never be reused. **D-024…D-027 came from the Task 2 sessions on 2026-08-01; the next free ID is D-028.** 19 of the 24 live findings were submitted to the §7 Google Form on 2026-08-02; **D-023 and D-024…D-027 still need submitting.**

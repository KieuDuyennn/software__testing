...
- **Finding IDs are `D-0NN`, allocated when a finding is written, never in advance.** D-001…D-022
  ...
  never be reused. **D-024…D-028 came from Task 2 on 2026-08-03; the next free ID is D-029.** 24 of the 25 live findings are submitted; **D-028 (raised 2026-08-03 from the P5 recording) is not yet on the §7 form.**
...
| §7 form + log | 10 | Log complete and validated (**25 findings**); **24 submitted** from `lpkduyen23@clc.fitus.edu.vn`: 19 on 2026-08-02, five (D-023, D-024…D-027) on 2026-08-03. **D-028 outstanding** — log 25, form 24. Timestamp column is date-level, not minute-level. |

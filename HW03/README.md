...
| **1B**: Execution on D1-D6 | **Done.** All 60 items of checklist v1.9 run against all 6 screens (360 item×screen cells; the checklist has since grown to 62, and the 2 newer items are unrun), screen by screen on the live system. 133 applicable · **117 executed** · 98 Pass · 19 Fail · 227 N/A-with-reason · 16 not executed, each with a named cause and a named owner. 19 findings stand, every Fail backed by a screenshot or DevTools evidence. Three further findings were raised and then retracted after being re-tested against the live product. |
...
- **Item × screen cells resolved:** 360 designed → 133 applicable → **117 executed** (98 Pass / 19 Fail), 16 not executed with named causes — 12 of them the Slow-3G / Offline cells that need CDP network control.

...
Checklist version: `docs/01_Task1A_Shared_GUI_Checklist.md` v1.9, 60 items. The full verification rule and expected behaviour for every Item ID live there; this file records Result, Notes and Evidence only.

...
**Why TC-01 is not credited for EC-16/EC-17 in §5 (fixes P3-G01):** TC-01's
...
relevant (fixes P3-G05): TC-01's precondition (5 orders — the largest data
...
`gap_notes.md`). Re-verified line by line, not just re-ticked.
...
- [x] Selection rule applied exactly (D-1): valid/non-erroneous classes
      ...
      combines two invalid conditions. **Corrected claim (fixes P3-G01):**
...
- [x] No Open Question was resolved or guessed — every TC expected result
      ...
      OQs plus new OQ-15. **Corrected omission (fixes P3-G05):** OQ-12

...
**Scope caveat (fixes Phase 4 self-critique finding P4-G02):** the `min = 0`
...
- [x] The two ordered domains (`total_amount` per order vs. count of
      ...
      (flagged explicitly in §4). **Corrected (fixes P4-G02):** domain (b)'s
...
- [x] Every BVA test case traces to its EC(s)/REQ(s), and boundary points
      ...
      **Corrected (fixes P4-G03):** BVA-06's choice of `3` (rather than the
...
- [x] No Open Question was resolved or guessed — OQ-09's two hypotheses are
      ...
      assumed away, per special instruction 4. **Corrected (fixes P4-G01):**
      ...
      fixed by hand). **Corrected (fixes P4-G05):** OQ-14 and OQ-15

...
exclusion has since been reversed** (fixes Phase 4 self-critique finding
P4-G02 — see below).
...
**Added to reverse the original exclusion (fixes P4-G02) — see §0's Price
...
**Test-case count, stated plainly (fixes P4-G01):** Phase 4 adds **2**
...
P4-G03 applied). Re-verified line by line, not just re-ticked.
...
- [x] Display fields (image, name, description, category) remain
      ...
      skipped. **Price's exclusion is reversed (fixes P4-G02):** §0/§2
      ...
      before.
- [x] **Carried-forward Phase 2 gap disclosed, not silently patched
      (fixes P4-G02's second part):** §4 notes that no negative-price
...
- [x] **Project-wide test-case count stated explicitly and correctly
      (fixes P4-G01):** §3 now states "13 (Phase 3) + 3 (Phase 4:

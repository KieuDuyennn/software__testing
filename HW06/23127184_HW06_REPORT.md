...
student must review/adapt the source and be able to explain every decision in
...
example response, final student authorship review of the editable diagram, and
the narrated YouTube video. The mandatory executed Postman Console evidence is
complete.

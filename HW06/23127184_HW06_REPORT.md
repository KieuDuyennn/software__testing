...
The original run's 128 failed assertions are expected defect-revealing results
and are clustered into 16 confirmed bugs. After the defects and contradictory
fixture were corrected, the same 386-case suite passed **1,802/1,802
assertions** in final CI. The original failure evidence is retained for audit.

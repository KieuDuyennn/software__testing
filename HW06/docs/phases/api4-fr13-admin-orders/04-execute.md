# API 4 - FR-13 Admin Dashboard - Phase 4: Execute
...
| Collection | `collections/API4_FR13_AdminOrders.postman_collection.json` |
| Environment | `config/eshop-local.postman_environment.json` |
| Data file | `data/api4_fr13_admin_orders.csv` |

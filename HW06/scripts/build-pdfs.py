...
def main():
    ...
    report = OUT / "23127184_HW06_AI_API_Report.pdf"
    audit = OUT / "23127184_HW06_AI_Audit_Report.pdf"
    build(ROOT / "23127184_HW06_REPORT.md", report)
    build(ROOT / "docs" / "ai-audit" / "AI_AUDIT.md", audit)
    render_and_validate(
        report, "report",
        ["23127184", "FR-01", "FR-06", "FR-11", "FR-13", "AI Critique"],
    )
    render_and_validate(audit, "audit", ["AI Audit Report", "Interaction log"])

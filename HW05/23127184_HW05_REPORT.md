...
capacity. A 198-VU Stress retest is prepared but should run only after the host
again has at least 2 GB free RAM.

Demo video and Agent Skill demonstration: **VIDEO_URL_PENDING**. The remaining
anti-cheat submission action is for the student to record/upload an unlisted
video of at least six minutes with their own Vietnamese narration, then replace
this marker and the two markers in `README.md` before packaging.
